  Pod::Spec.new do |spec|
    ...
    spec.name         = "TTSDK"
    spec.version      = "1.25.2.1-standard"
    ...
    spec.subspec 'Core' do |subspec|
      ...
      subspec.dependency 'RangersAppLog/Core', '< 7.0.0'
      subspec.dependency 'RangersAppLog/Host/CN', '< 7.0.0'
    ...
    spec.subspec 'Live-RTC' do |subspec|
      subspec.vendored_frameworks = [
        'TTSDK/ByteRtcSDK/VolcEngineRTC.xcframework/ios-arm64_armv7/*.framework',
      ]
    end
