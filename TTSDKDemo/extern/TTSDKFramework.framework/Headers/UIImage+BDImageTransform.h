 ...
 */
+ (nullable UIImage *)bd_imageWithSmallGIFData:(nullable NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)bd_imageWithColor:(nullable UIColor *)color;
 ...
 */
+ (nullable UIImage *)bd_imageWithColor:(nullable UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)bd_imageWithSize:(CGSize)size drawBlock:(void (^)(_Nonnull CGContextRef context))drawBlock;
 ...
 */
- (void)bd_drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips;
 ...
 */
- (nullable UIImage *)bd_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)bd_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)bd_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)bd_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 the width or height.
 */
- (nullable UIImage *)bd_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)bd_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)bd_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)bd_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)bd_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)bd_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)bd_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)bd_imageByBlurWithTint:(nullable UIColor *)tintColor;
...
/**
 ...
 the result of the blur and saturation option. The
 ...
 enough memory).
 */
- (nullable UIImage *)bd_imageByBlurRadius:(CGFloat)blurRadius
