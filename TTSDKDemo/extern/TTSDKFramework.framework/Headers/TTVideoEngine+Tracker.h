...
@property (nonatomic, nonnull, copy) NSString *userUniqueId DEPRECATED_MSG_ATTRIBUTE("not support");

@end

@interface TTVideoEngine(Tracker)
+ (void)tracker_start:(nullable TTVideoEngineDeviceInfo)callBack DEPRECATED_MSG_ATTRIBUTE("please use RangersAppLog SDK");
@end
